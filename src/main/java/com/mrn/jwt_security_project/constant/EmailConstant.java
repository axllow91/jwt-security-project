package com.mrn.jwt_security_project.constant;

public class EmailConstant {
    public static final String SIMPLE_EMAIL_TRANSFER_PROTOCOL = "smtps";
    public static final String USERNAME = "Ashuraizanaghi2233@gmail.com";
    public static final String PASSWORD = "Itamioshire2244";
